...
function calculateMetrics(answers) {
  ...
  if (leadsMes !== null) {
    ...
    const remainingAfterVentasRecovery = leadsPerdidos * (1 - CONFIG.tasaRecuperacionRealista);
    const sinSeguimiento = (remainingAfterVentasRecovery * (10 - tasaSeguimiento)) / 10;
